...
@app.route("/coleta")
def coleta():
    global paciente_nome, n_coleta_ruim, n_coleta_bom
...
def coleta_paretico():
    global paciente_nome
    return render_template("paretico.html", paciente_nome=paciente_nome)
...
def coleta_saudavel():
    global paciente_nome
    return render_template("saudavel.html", paciente_nome=paciente_nome)
...
def graficos():
    global paciente_nome
    return render_template("graficos.html", paciente_nome=paciente_nome)

@app.route("/tabelas")
def tabelas():
    global paciente_nome
    return render_template("tabelas.html", paciente_nome=paciente_nome)

@app.route("/area-dev")
def area_dev():
    global paciente_nome
    return render_template("area_dev.html", paciente_nome=paciente_nome)
